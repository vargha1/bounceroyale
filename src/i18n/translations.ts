...
const en: Dict = {
  ...
  pressTab: 'Press V to switch players',
  gameOver: 'Game Over',
  rank: 'Rank',
  ...
  controlsHint: 'WASD = move   ·   Space = jump   ·   Mouse = aim   ·   Click = shoot   ·   1/2 = weapon   ·   R = reload   ·   Esc = pause',
...
const fa: Dict = {
  ...
  pressTab: 'برای تعویض بازیکن، V را بزنید',
  ...
  controlsHint: 'WASD = حرکت   ·   Space = پرش   ·   ماوس = نشانه‌گیری   ·   کلیک = شلیک   ·   ۱/۲ = سلاح   ·   R = شارژ   ·   Esc = توقف',
